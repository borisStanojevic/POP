...
namespace Project.Model
{
    public class ProjectMain
    {
        ...
        private List<ActionSale> actionSalesList;
        ...
        public List<ActionSale> ActionSalesList
        {
            get
            {
                this.actionSalesList = GenericSerializer.Deserialize<ActionSale>("action_sales.xml");
                return this.actionSalesList;
            }
            set
            {
                this.actionSalesList = value;
